...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_uniqueTriggerId":"30238805_3",
      ...
      "vtp_uniqueTriggerId":"30238805_13",
      "tag_id":16
    }],
  "predicates":[{
      "function":"_eq",
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.s[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.w="GTM-567QDCQ";Vc.Kb="432";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var $c=Zc,ad=null,bd=null,cd=null,dd="//www.googletagmanager.com/a?id="+Vc.w+"&cv=3",ed={},fd={},gd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var hd={},jd=function(a,b){hd[a]=hd[a]||[];hd[a][b]=!0},kd=function(a){for(var b=[],c=hd[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
Z.a.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.b="ctv";Z.__ctv.g=!0;Z.__ctv.priorityOverride=0})(function(){return"3"})}();
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var A=[],B=x.split(","),z=0;z<B.length;z++){var E=Number(B[z]);if(isNaN(E))return[];p.test(B[z])||A.push(E)}return A}function c(){var x=0,A=0;return function(){var B=rk(),z=B.height;x=Math.max(v.scrollLeft+B.width,x);A=Math.max(v.scrollTop+z,A);return{ig:x,jg:A}}}function d(){q=X("self");
t=q.document;v=t.scrollingElement||t.body&&t.body.parentNode;y=c()}function e(x,A,B,z){var E=l(A),H={},K;for(K in E){H.Ga=K;if(E.hasOwnProperty(H.Ga)){var R=Number(H.Ga);x<R||(Gk({event:"gtm.scrollDepth","gtm.scrollThreshold":R,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":z,"gtm.triggers":E[H.Ga].join(",")}),Xj("sdl",A,function(V){return function(fa){delete fa[V.Ga];return fa}}(H),{}))}H={Ga:H.Ga}}}function f(){var x=y(),A=x.ig,B=x.jg,z=A/v.scrollWidth*100,E=B/v.scrollHeight*100;e(A,"horiz.pix",
r.Ib,u.Dd);e(z,"horiz.pct",r.Hb,u.Dd);e(B,"vert.pix",r.Ib,u.Xd);e(E,"vert.pct",r.Hb,u.Xd);Wj("sdl","pending",!1)}function h(){var x=250,A=!1;t.scrollingElement&&t.documentElement&&q.addEventListener&&(x=50,A=!0);var B=0,z=!1,E=function(){z?B=Ck(E,x):(B=0,f(),Kk("sdl")&&!a()&&(nc(q,"scroll",H),nc(q,"resize",H),Wj("sdl","init",!1)));z=!1},H=function(){A&&y();B?z=!0:(B=Ck(E,x),Wj("sdl","pending",!0))};return H}function k(x,A,B){if(A){var z=b(String(x));Xj("sdl",B,function(E){for(var H=0;H<z.length;H++){var K=
String(z[H]);E.hasOwnProperty(K)||(E[K]=[]);E[K].push(A)}return E},{})}}function l(x){return Yj("sdl",x,{})}function m(x){I(x.vtp_gtmOnSuccess);var A=x.vtp_uniqueTriggerId,B=x.vtp_horizontalThresholdsPixels,z=x.vtp_horizontalThresholdsPercent,E=x.vtp_verticalThresholdUnits,H=x.vtp_verticalThresholdsPixels,K=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case r.Ib:k(B,A,"horiz.pix");break;case r.Hb:k(z,A,"horiz.pct")}switch(E){case r.Ib:k(H,A,"vert.pix");break;case r.Hb:k(K,
A,"vert.pct")}Kk("sdl")?Yj("sdl","pending")||(w||(d(),w=!0),I(function(){return f()})):(d(),w=!0,v&&(Lk("sdl"),Wj("sdl","pending",!0),I(function(){f();if(a()){var R=h();mc(q,"scroll",R);mc(q,"resize",R)}else Wj("sdl","init",!1)})))}var p=/^\s*$/,r={Hb:"PERCENT",Ib:"PIXELS"},u={Xd:"vertical",Dd:"horizontal"},q,t,v,w=!1,y;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?m(x):oj(function(){m(x)})})}();
